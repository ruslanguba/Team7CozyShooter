...
public class PillowThrowHandler : GunBase
{
    ...
    private int _currentIndex = -1; // индекс текущей лет€щей подушки
    ...
    {
        // если сейчас летит подушка, останавливаем еЄ
        if (_currentRb != null)
        {
            StopCurrentPillow();
            return;
    ...
    private GameObject GetNextPillow()
    {
        ...
        return null; // все подушки в полЄте
    }
    ...
    private void ThrowPillow(GameObject pillow)
    {
        ...
        _thrownPillows.Push(pillow); // кладЄм подушку в стек
